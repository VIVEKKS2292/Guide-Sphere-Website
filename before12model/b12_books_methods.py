...
sheet = client.open_by_url("https://docs.google.com/spreadsheets/d/18JSRn7gSWtQoMX75CJsKDDk4QGZEI6AZEGGImlxzBQQ/edit#gid=226312399")
...
books = books[['book_title','book_url','book_img','book_author','book_price','book_store','book_id']]
...
books['temp_book_store'] = books['book_store']
books['temp_book_store'] = books['temp_book_store'].apply(clean_title)
books['temp_book_store'] = books['temp_book_store'].apply(lambda x: x.split())
...
books['tags'] = books['temp_title'] + books['temp_book_author'] + books['temp_book_store'] 
...
def recommend_books(keyword):
    ...
    for idx in top_indices:
        book_details = {
            ...
            'book_price': books.iloc[idx]['book_price'],
            'book_store': books.iloc[idx]['book_store'],
...
def getBook(title):
    ...
    if book_data.empty:
        ...
        book_details = {
            ...
            'book_store': book_data['book_store'],

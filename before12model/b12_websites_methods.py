...
sheet = client.open_by_url("https://docs.google.com/spreadsheets/d/1fR6dfZx0WlR6zGVEfbXqb3dmHStlVRBDQvGurgAkce4/edit#gid=0")
...
websites['tags'] = websites['temp_web_title'] + websites['temp_web_platform'] + websites['temp_web_short_desc']
